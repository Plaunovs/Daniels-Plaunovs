...
- **Bakalaura darbs: Atvērtā koda sejas atpazīšanas sistēmu analīze**: salīdzinošs pētījums par face_recognition, DeepFace un InsightFace bibliotēkām 1:N identifikācijā ar atteikumu, kā arī paša izstrādāts hibrīdrisinājums (RetinaFace + dlib izlīdzināšana + ArcFace). Hibrīdrisinājums sasniedza 98,33 % precizitāti un bija ātrākais (333,51 ms uz attēlu). Nevienā sistēmā nebija kļūdainu identifikāciju.
  [github.com/Plaunovs/bakalaurs](https://github.com/Plaunovs/bakalaurs)
